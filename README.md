...
* **🏃 Portable Execution:** Dynamically resolves its own file path, meaning you can drop the script in any folder or drive and run it immediately without modifying code.
...
> * Downloads and metadata-enriches all available wallpapers into the `_OUT` directory relative to where you placed the script.
